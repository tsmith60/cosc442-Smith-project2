...
public class RectangleTest {
	...
	public void testGetArea() {
		System.out.println("Rect1 p1: "+rect1.getPoints()[0].x+", "+rect1.getPoints()[0].y);
		System.out.println("Rect1 p2: "+rect1.getPoints()[1].x+", "+rect1.getPoints()[1].y);
		assertEquals(10.0, rect1.getArea(),0.001);
		System.out.println("Rect1 p1: "+rect2.getPoints()[0].x+", "+rect2.getPoints()[0].y);
		System.out.println("Rect1 p2: "+rect2.getPoints()[1].x+", "+rect2.getPoints()[1].y);
